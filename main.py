"""Entry point for YOLOv8 + Kalman tracking pipeline.
...
def main():
    ...
    parser.add_argument("--class-id", type=int, default=0,
                        help="Class id to detect (0=person).")
    ...
    try:
        if args.mode == "yolo":
            run_yolo_only(cap, out, model, args.conf, args.class_id, frame_count)
        else:
            run_with_kalman(
                cap, out, model, args.conf, args.class_id,
